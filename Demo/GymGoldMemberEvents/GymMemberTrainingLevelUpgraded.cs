...
{
    [ProtoContract]
    public class GymMemberTrainingLevelUpgraded : IEvent    
    {
        public GymMemberTrainingLevelUpgraded()
        {

        }

        public GymMemberTrainingLevelUpgraded(Guid aggid, Enums.TrainingLevels level)
        {
            AggregateId = aggid;
